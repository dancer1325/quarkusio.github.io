    ...
    ** allows
        *** 👀if code changes ->
            **** run ONLY RELATED tests👀
                ***** Reason: 🧠Quarkus -- detects -- code / EACH test🧠
...
* if you want continuous testing to start automatically -> set `quarkus.test.continuous-testing=enabled` | `application.properties`
