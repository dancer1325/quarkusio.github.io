...
* goal
    ** use MongoDB database | your REST services
...
* application /
    ** user can add elements | list -- via a -- form
    ** browser's information is passed -- , as JSON, to -- the server

== Solution

* `mongodb-quickstart` link:{quickstarts-tree-url}/mongodb-quickstart[directory]
...
* URL -- to -- access the MongoDB instance
    ** == 💡main property to configure💡
    ** enable you
        *** 👀configure ALMOST ALL👀
...
[source,properties]
----
# mongoDB client / replica set of 2 nodes
...
[source,properties]
----
# mongoDB client / 1! instance | localhost
...
* ways
    ...
    ** <<dev-services,Dev Services>>
        *** ❌NOT launch the container manually❌
