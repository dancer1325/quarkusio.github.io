...
* use cases
    ** execute custom actions | application starts
    ** clean up everything | application stops

* goal
    ** how to write
        *** Quarkus application -- via -- main method
        *** command mode applications / run a task & then terminate
    ** how to be notified
        *** | application starts
        *** | application stops
...
* link:{quickstarts-tree-url}/lifecycle-quickstart[here]
