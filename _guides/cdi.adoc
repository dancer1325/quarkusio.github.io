...
* goal
    ** Quarkus programming model
        *** == -- based on -- https://jakarta.ee/specifications/cdi/4.1/jakarta-cdi-spec-4.1.html[Jakarta Contexts and Dependency Injection 4.1 specification, window="_blank"]
...
* 💡ALL💡
    ** ❌EXCEPT for `jakarta.enterprise.context.ConversationScoped`❌

[options="header",cols="1,1"]
|===
|Annotation   |Description
//----------------------
|`@jakarta.enterprise.context.ApplicationScoped`   | 1! bean instance /

&nbsp;&nbsp; used -- for the -- application

&nbsp;&nbsp; shared AMONG ALL injection points

&nbsp;&nbsp; created lazily == \| method is invoked -- through -- <<client_proxies, client proxy>>
|`@jakarta.inject.Singleton`   | vs `@ApplicationScoped`

&nbsp;&nbsp; ❌NO use client proxy❌

\| injection point / resolves to a @Singleton bean is being injected, instance is created
|`@jakarta.enterprise.context.RequestScoped`   | bean instance is associated -- with the -- CURRENT _request_ (normally HTTP request)
...
* Quarkus extensions can provide OTHER custom scopes
    ** _Example:_ xref:transaction.adoc[`quarkus-narayana-jta`] provides xref:transaction.adoc#transaction-scope[`jakarta.transaction.TransactionScoped`]
