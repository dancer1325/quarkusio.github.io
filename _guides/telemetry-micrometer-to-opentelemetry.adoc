...
* telemetry-micrometer-opentelemetry
    ** == extension /
        *** == xref:telemetry-micrometer.adoc[micrometer extension] + xref:opentelemetry.adoc[opentelemetry extension] + bridge BETWEEN them
    ** provides
        *** | Quarkus applications, support for Micrometer & OpenTelemetry
    ** allows
        *** using Micrometer API /
            **** metrics are handled -- by the -- OpenTelemetry extension
    ** requirements
        *** | Quarkus v3.19
