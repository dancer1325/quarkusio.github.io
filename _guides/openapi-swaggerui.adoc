...
* Quarkus
    ** provides
        *** https://github.com/smallrye/smallrye-open-api/[SmallRye OpenAPI extension] generates -- , compliant with the https://github.com/eclipse/microprofile-open-api/[MicroProfile OpenAPI] specification, -- your API
...
----
# if you do NOT want to like -> default endpoint location `/q/openapi`
...
* MicroProfile OpenAPI annotations / describe global API information
    ** are
        ...
        *** License
    ** uses
        *** use appropriate OpenAPI annotations | Jakarta REST `Application` class
* empty class /
    ** extends `jakarta.ws.rs.core.Application`
    ** can be annotated -- with -- various OpenAPI annotations
* ALTERNATIVE
    ** feature provided by SmallRye and not part of the specification is to use configuration to add this global API information.
