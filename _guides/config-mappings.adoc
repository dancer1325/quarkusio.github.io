...
* requirements
    ** 👀public interface / `@io.smallrye.config.ConfigMapping` annotated👀
...
* allows
    ** override the method name mapping
* use cases
...
* allows
    ** inherit its container name / ❌NOT use the configuration property name❌
