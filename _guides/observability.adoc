...
* https://opentelemetry.io/docs/specs/otel/protocol/[OpenTelemetry OTLP protocol]
    ** == 👀recommended way -- to -- send telemetry out of a Quarkus application👀
...
* | generate observability events | Quarkus , ❌NO recommended way❌
    ** Reason:🧠OpenTelemetry Events API
...
* OpenTelemetry Metrics
    ** AVAILABLE -- via -- xref:opentelemetry.adoc[`quarkus-opentelemetry`] extension
        *** by default, disabled
            **** Reason:🧠 metrics semantic conventions are NOT stable yet🧠
