...
* 👀Quarkus extensions / build & push container images👀
- <<#jib,Jib>>
- <<#docker,Docker>>
- <<#podman,Podman>>
- <<#openshift,OpenShift>>
...
* `quarkus-container-image-jib`
    ...
    ** benefit
        *** 💡rebuilds really fast & small💡
            **** Reason:🧠ALL the dependencies (| "target/lib") are cached | layer != actual application layer🧠
        *** ❌enable you NOT need to
            **** have a dedicated client side tooling / create a container image -- _Example:_ Docker --
            **** run a daemon process -- _Example:_ Docker daemon --❌

:add-extension-extensions: container-image-jib
include::{includes}/devtools/extension-add.adoc[]

* requirements: if you want ALSO to push | registry
