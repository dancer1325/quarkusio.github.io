...
* Micrometer
    ** | Quarkus applications,
        *** recommended approach, to metrics /
            **** by default,
                ***** 👀exposed | main HTTP server -- "/q/metrics" -- 👀
            **** customize to surface metrics | <<management-interface, separate management port>>
    ** provides
        *** <<Create your own metrics,abstraction layer -- for -- metrics collection>>
        *** API -- for - basic meter types (_Examples:_ <<Counters,counters>>, <<Gauges,gauges>>, <<Summaries and Timers,timers and summaries>>)
        *** <<Create a customized MeterRegistry,`MeterRegistry` API>> / generalizes different backend monitoring systems
            **** metrics collection
            **** propagation
...
* Quarkus Micrometer extensions structure
    ** == 👀Micrometer project structure👀
    ** == `quarkus-micrometer` extension (== core Micrometer + runtime integration) + OTHER extensions
        *** OTHER extensions
            **** provide support -- for -- OTHER monitoring systems

* Quarkus extensions
    - micrometer
    - micrometer-registry-prometheus
        ** ⚠️ALSO include `quarkus-micrometer`⚠️

* link:https://github.com/quarkiverse/quarkus-micrometer-registry[Quarkiverse extensions]
...
=== if you want to support Prometheus metrics -> use `micrometer-registry-prometheus` extension

:add-extension-extensions: micrometer-registry-prometheus
include::{includes}/devtools/extension-add.adoc[]

* | your build file, it would add
    ** | Maven
+
...
* steps
    ** | "application.properties",
        *** `quarkus.management.enabled=true`
            ...
            **** exposed | "http://0.0.0.0:9000/q/metrics"
...
* xref:./management-interface-reference.adoc[MORE about management interface]
