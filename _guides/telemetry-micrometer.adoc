...
* Micrometer
    ** | Quarkus applications,
        *** recommended approach to metrics /
            ...
            **** if you would like to surface metrics -- from a -- separate management port -> <<management-interface,Managed interface>>
    ** provides
        *** abstraction layer -- for -- metrics collection
        *** API -- for - basic meter types (_Examples:_ counters, gauges, timers, and distribution summaries)
        *** `MeterRegistry` API / generalizes for different backend monitoring systems
            **** metrics collection
            **** propagation
...
* Quarkus extensions
    ...
    - micrometer-registry-prometheus
        ** 👀ALSO include `quarkus-micrometer`👀
