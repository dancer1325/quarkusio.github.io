...
| `projectArtifactId`
| _mandatory_
| created project's artifactId. if you do NOT pass -> interactive mode
...
* built-in Quarkus
* 👀if you update code / resources / configurations -> AUTOMATICALLY reflected | your running application👀
    ** code -> refresh browser -> repeat
    ** -> make easier development [database, UI]
* enables
...
* refresh the browser
    ** -- triggers a -- scan of the workspace
